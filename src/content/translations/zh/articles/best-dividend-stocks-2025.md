---
title: "2025 年最佳股息股票：年度回顾（历史档案）"
description: "2025 年历史回顾：梳理当年表现最佳的股息股票、股息贵族和高收益标的。这是 2025 年复盘，并非 2026 年当前推荐；当前标的见我们的股票研究列表。"
---

> **历史档案说明（2025）：** 本页是对 2025 年股息股票选择的年度回顾。当前推荐请见我们的[股票研究列表](/zh/stocks/)。
...
本文按真正重要的指标回顾了 2025 年的股息股票：收益率、派息率、连续增长年限和实际总回报，并解释优质增长型股票与高收益标的应如何搭配。这是 2025 年历史复盘，不是当前买入清单。

## 2025 年最佳股息股票排名

以下公司在 2025 年都提高了股息，没有一家削减派息；它们当年的收益率、派息率和连续增长记录，也解释了为什么这些公司被视为同类中的优质标的。
...
*收益率为 2025 年末时点数；总回报为 2025 日历年价格回报加再投资分配，近似值 ±1-2%。*
...
这些股票属于"平淡但有效"的核心标的。它们收益率不高，但几十年来持续提高股息。2025 年它们的派息增幅约为 4.8% 至 5.8%，高于约 3% 的通胀率。收益率今天看起来不高，但会随着时间推移不断提高你的成本收益率。
...
2025 年持续胜出的特征：连续派息超过 25 年、派息率低于约 70%，以及具有持久竞争优势的业务。JNJ、KO、PG、ABBV 和 MCD 符合这一框架，VZ 和 O 可以作为收入型补充。当前观察名单请见我们的[股票研究列表](/zh/stocks/)。

### 2025 年什么样的股息收益率算健康？

2025 年，健康收益率通常取决于行业，大致在 2% 至 5% 之间。优质增长型股票往往为 2% 至 3%，高收益股票约为 4% 至 6%，而非 REIT 或 BDC 股票如果超过 8%，通常需要格外警惕。收益率随价格变动，行动前请核对当前数据。

## 下一步：如何建立股息组合

2025 年股息股票市场的经验是：以增长型标的打底获取可靠性，以高收益标的补充收入，让股息增长随时间复利。JNJ、ABBV 和 KO 在 2025 年提高股息的同时取得了 16-47% 的总回报——这正是股息投资的威力所在。

上面这些名字是 2025 年复盘。要建立当前组合，同样的原则仍然适用——但在行动前请核对今天的收益率、价格和连续增长状态：
...
用[股息计算器](/zh/calculator/) 测算你的收入，在我们的[股票研究列表](/zh/stocks/) 中比较候选标的，并阅读[股息策略](/zh/strategy/) 指南了解哪种方法适合你的目标。刚接触股息？可以从[股息是什么](/zh/articles/what-are-dividends/) 或[股息率解释](/zh/articles/dividend-yield/) 开始。
