...
*Approximate average monthly distributions per [JPMorgan fund disclosures](https://am.jpmorgan.com/us/en/asset-management/adv/products/jpmorgan-nasdaq-equity-premium-income-etf-etf-shares-46654q203). Actual amounts vary monthly and should be verified against the official distribution schedule.*
...
*Total return reflects distributions plus price change. Per [fund performance data](https://am.jpmorgan.com/us/en/asset-management/adv/products/jpmorgan-nasdaq-equity-premium-income-etf-etf-shares-46654q203). Returns vary and past performance is not indicative of future results.*
...
Mostly no. JEPQ's distributions are largely treated as ordinary income (options premium), making it tax-inefficient in taxable accounts. Per [IRS rules for Form 1099-DIV](https://www.irs.gov/forms-pubs/about-form-1099-div), distribution character is reported on your 1099-DIV. Consider holding JEPQ in an IRA or 401(k).
...
1. **Great for income** — ~9-10% yield, monthly payments
2. **Moderate risk** — diversified, but still equity exposure
...
2. **Check your account type first** — distributions are ordinary income, so an IRA/401(k) beats a taxable account for JEPQ
3. **Size it as a complement, not the core** — pair JEPQ with SCHD or Dividend Aristocrats for balance
...
*Henry Zhou personally checks fund data against JPMorgan disclosures, SEC filings, and independent ETF data sources.*
