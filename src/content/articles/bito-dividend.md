...
1. **Realized gains on futures** as bitcoin rises — this is the bulk of the big payouts
2. **Interest income** from the cash and Treasury collateral
3. **Roll yield** — a gain or drag from the futures curve, which flips between contango and backwardation
...
*Distribution totals per [StockAnalysis.com BITO dividend history](https://stockanalysis.com/etf/bito/dividend/) and [DividendMax](https://www.dividendmax.com/), August 2026. Amounts are variable distributions, not fixed dividends.*
...
Mostly as ordinary income, with some return of capital depending on the year. Distributions are reported on Form 1099-DIV; see [IRS.gov](https://www.irs.gov) for the rules on ETF distributions.
