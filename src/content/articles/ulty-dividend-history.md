...
*Distribution amounts per [YieldMax public disclosures](https://www.yieldmaxetfs.com/funds/ulty/). Figures approximate and should be verified against the fund's official distribution schedule.*
...
Per [SEC fund disclosure standards](https://www.sec.gov/), investors should distinguish **distribution yield** (cash paid ÷ current price) from **total return** (what you actually earn after price changes).
