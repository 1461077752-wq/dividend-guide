---
title: "TSLY Dividend History and Distributions"
description: "Complete TSLY distribution history since its November 2022 launch — the 2023 payout peak, the 2025 switch to weekly, and why the ~109% yield misleads."
pubDate: 2026-08-04
modDate: 2026-08-04
...
author: "Henry Zhou"
dataAsOf: "2026-08-04"
methodology: "Distribution history is based on published fund distributions; annualized yield is separated from realized total return."
sources:
...
<!-- Cover image: Electric vehicle charging in front of a financial chart on a screen, representing Tesla-linked option income investing -->
...
*Fund facts per [StockAnalysis.com TSLY data](https://stockanalysis.com/etf/tsly/) and [YieldMax official fund page](https://www.yieldmaxetfs.com/tsly/), August 2026. Distribution amounts below are reported as-paid; see the split-adjusted note in each section.*
...
*Monthly distribution data per [StockAnalysis.com TSLY dividend history](https://stockanalysis.com/etf/tsly/dividend/) and YieldMax distribution releases, August 2026. Amounts vary and should be verified against YieldMax's official distribution schedule.*
...
In October 2025, TSLY moved from monthly to **weekly** distributions — the first weekly ex-date was October 16, 2025, after a final larger monthly payment on October 2 ($0.8020, the largest single payment of the year). Per [YieldMax's distribution schedule](https://www.yieldmaxetfs.com/distribution-schedule/), TSLY is now a "Group 2" weekly payer with Thursday ex-dates.
...
*Weekly distribution data per [StockAnalysis.com](https://stockanalysis.com/etf/tsly/dividend/), August 2026.*
...
*Split-adjusted figures per [StockAnalysis.com](https://stockanalysis.com/etf/tsly/dividend/), which adjusts historical amounts for the split.*
...
*Performance figures per [YieldMax official TSLY page](https://www.yieldmaxetfs.com/tsly/) and [StockAnalysis.com](https://stockanalysis.com/etf/tsly/), July–August 2026.*
...
*Data per [StockAnalysis.com](https://stockanalysis.com/etf/tsly/) fund pages, August 2026.*
...
Mostly no. TSLY payouts are largely ordinary income and return of capital, reported on [Form 1099-DIV](https://www.irs.gov). The ROC portion isn't taxed immediately but reduces your cost basis. TSLY is tax-inefficient for taxable accounts.
...
1. **Judge TSLY by total return, never by yield** — the ~109% headline is split-adjusted math on a declining price
2. **Watch the ROC percentage** — high return-of-capital shares mean the payout is eating the share price
...
*Henry Zhou personally checks distribution data against YieldMax fund disclosures, SEC filings, and independent ETF data sources.*
