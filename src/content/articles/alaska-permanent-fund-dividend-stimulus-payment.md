...
primaryKeyword: "Alaska permanent fund dividend"
...
<!-- Cover image: Alaska landscape with mountains and northern lights, representing the state's natural resource wealth that funds the Permanent Fund dividend -->
...
|------|---------|---------------------|--------------|--------|
| 2020 | $992 | $0 | $992 | [Alaska Dept. of Revenue](https://pfd.alaska.gov) |
| 2021 | $1,114 | $0 | $1,114 | [Alaska Dept. of Revenue](https://pfd.alaska.gov) |
| 2022 | $1,284 | $662 (energy relief) | $3,284 | [Alaska Legislature](https://akleg.gov) |
| 2023 | $1,312 | $0 | $1,312 | [Alaska Dept. of Revenue](https://pfd.alaska.gov) |
| 2024 | $1,702 | $0 | $1,702 | [Alaska Dept. of Revenue](https://pfd.alaska.gov) |
| 2025 | $1,650 (est.) | TBD | TBD | Legislative budget proposals |

*Source: [Alaska Department of Revenue, Permanent Fund Dividend Division](https://pfd.alaska.gov).*

The 2022 payment was notably the largest in recent history due to a one-time $662 energy relief supplement added by the [Alaska Legislature](https://akleg.gov) in response to high fuel and heating costs.

## Eligibility Requirements

To qualify for the PFD, you must meet several criteria set by the [Alaska Department of Revenue](https://pfd.alaska.gov):
...
The base PFD formula (Alaska Statute [AS 43.23](https://www.akleg.gov/basis/statutes.asp#43.23)) uses a five-year average of the Permanent Fund's realized investment earnings, divided equally among all applicants. When the [Alaska Legislature](https://akleg.gov) approves an **additional appropriation**, it is typically labeled as "energy relief" or "supplemental" — but many residents call it a "stimulus" payment because it functions similarly to a one-time government transfer.
...
- The [IRS](https://www.irs.gov) treats the PFD as ordinary income
...
- Per [IRS Publication 525](https://www.irs.gov/publications/p525), the PFD must be reported on Line 8 (Other Income) of Form 1040
...
Yes. The [Alaska Department of Revenue](https://pfd.alaska.gov) provides an online portal at [myPFD.alaska.gov](https://myPFD.alaska.gov) where applicants can check status, update contact information, and view payment history.
