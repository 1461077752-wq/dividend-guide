...
<!-- Cover image: Calculator next to financial documents showing yield calculations, representing dividend yield math -->
...
A few real examples as of August 2026 (per [StockAnalysis.com](https://stockanalysis.com/)):
...
The trap: a stock that falls from $100 to $50 (dividend unchanged) looks like it's offering double the yield — but you own the same falling asset. **A rising yield from a falling price is not new income; it's a risk signal.** Per [Charles Schwab's analysis of rising yields](https://www.schwab.com/learn/story/rising-dividend-yields-red-flags), high-yield payers cut their dividends at roughly twice the rate of moderate-yield payers.
...
*Yield ranges based on data from [StockAnalysis.com](https://stockanalysis.com/), [Schwab](https://www.schwabassetmanagement.com/products/schd), and general market observations, August 2026.*
...
A 5% yield can produce a negative total return if the stock falls 15%. Conversely, a 2% yield can deliver 12% total return when the price rises. [Morningstar](https://www.morningstar.com/) and other research houses consistently show that reinvested dividends have historically contributed a large share of long-term stock returns — which is why yield matters, but not in isolation.
