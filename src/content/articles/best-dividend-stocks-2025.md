...
*Yield, payout ratio, and streak data per [StockAnalysis.com](https://stockanalysis.com/) stock pages; 2025 raises and total returns computed from dividend and price history, August 2026. Total returns approximate ±1-2%.*
...
For the "core" of a dividend portfolio, the quality dividend growers are the Aristocrats and Kings with decades of consecutive increases. Per [S&P Dow Jones Indices](https://www.spglobal.com/spdji/), a Dividend Aristocrat is an S&P 500 member with 25+ consecutive years of dividend increases — there are now **69 members**. The standouts from our list:
...
*Streak and payout data per [Simply Safe Dividends' 2026 Aristocrats list](https://www.simplysafedividends.com/world-of-dividends/posts/6-2026-dividend-aristocrats-list-all-69-ranked-analyzed) and StockAnalysis.com, August 2026.*
...
For income, a few names in our list pay well above the quality core — and they're the ones [Morningstar's 10 best dividend stocks](https://www.morningstar.com/) and other 2026 lists still highlight:
...
*Yield and payout data per [StockAnalysis.com](https://stockanalysis.com/), August 2026.*
...
One of the oldest dividend strategies — buying the 10 highest-yielding Dow stocks and holding for a year — delivered in 2025. The [2025 Dogs of the Dow list](https://www.dogsofthedow.com/2025-dogs-of-the-dow.htm) (based on yields at end-2024) included VZ (6.78%), CVX (4.50%), AMGN, JNJ, MRK, KO, IBM, CSCO, MCD, and PG:
...
The consensus across expert lists ([Morningstar](https://www.morningstar.com/), Motley Fool's 2026 top picks, Simply Safe Dividends) is **not either/or — it's both**. The pattern every 2025 list repeats:

1. **Core (60-70%):** quality dividend growers — JNJ, KO, PG, ABBV, MCD — for growing, reliable income
2. **Satellites (30-40%):** yield with discipline — VZ, O, CVX, PEP — for higher current income
3. **Screen on payout ratio and streak, not just yield** — the juiciest yields are often illusory
...
They're the most reliable. The [69 Dividend Aristocrats](https://www.simplysafedividends.com/world-of-dividends/posts/6-2026-dividend-aristocrats-list-all-69-ranked-analyzed) have raised dividends for 25+ consecutive years. But "best" also depends on your income needs — Aristocrats average ~2.5-3% yields, so high-yield satellites like VZ or O may still be needed.
