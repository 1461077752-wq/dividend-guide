...
<!-- Cover image: S&P 500 index chart with monthly income bars on a screen, representing index option income investing -->
...
*Fund facts per [StockAnalysis.com SPYI data](https://stockanalysis.com/etf/spyi/) and [NEOS fund page](https://neosfunds.com/spyi/), August 2026.*
...
*Monthly distribution data per [StockAnalysis.com SPYI dividend history](https://stockanalysis.com/etf/spyi/dividend/), August 2026. Amounts are variable and should be verified against NEOS's official distribution schedule.*
...
3. **Section 1256 tax treatment.** Because the fund uses exchange-traded SPX index options, gains and most distributions qualify for the lower **60/40 tax rate** and are largely classified as return of capital, per [NEOS's strategy disclosure](https://neosfunds.com/spyi/).
...
*Price and return data per [StockAnalysis.com SPYI history](https://stockanalysis.com/etf/spyi/) and [NEOS](https://neosfunds.com/spyi/), August 2026.*
...
*Fund data per [StockAnalysis.com](https://stockanalysis.com/etf/spyi/), [NEOS](https://neosfunds.com/spyi/), and [JPMorgan](https://am.jpmorgan.com/), August 2026.*
...
Mostly no — but better than ordinary income. SPYI's distributions are largely classified as return of capital, with the options portion taxed at the favorable 60/40 rate under Section 1256 per [NEOS](https://neosfunds.com/spyi/). ROC isn't taxed immediately but reduces cost basis. This makes SPYI more tax-efficient in taxable accounts than ELN-based funds.
...
Depends on your index preference. SPYI (S&P 500) is more diversified and yields ~12%; QQQI (Nasdaq-100) yields ~14% with more growth exposure and higher volatility. Same tax-advantaged engine, different index. See [our QQQI distribution history](/articles/qqqi-dividend-history/) for the other side.
