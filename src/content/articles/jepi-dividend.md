...
<!-- Cover image: Financial portfolio chart with steady income bars on a screen, representing defensive monthly income investing -->
...
*Fund facts per [StockAnalysis.com JEPI data](https://stockanalysis.com/etf/jepi/), August 2026.*
...
*Annual distribution data per [StockAnalysis.com JEPI dividend history](https://stockanalysis.com/etf/jepi/dividend/), August 2026. Amounts are variable monthly distributions, not fixed dividends.*
...
1. **Steady income** — option premiums convert into monthly distributions
2. **Lower volatility** — the calls buffer downside, giving JEPI a beta around 0.54 versus the S&P 500
3. **Capped upside** — when the market surges, JEPI participates less than the index
...
*Comparison per [StockAnalysis.com](https://stockanalysis.com/etf/jepi/) JEPI and JEPQ data, August 2026.*

JEPQ pays more (~11% vs ~8%) because Nasdaq-100 options carry richer premiums, but it also has higher volatility and a higher beta. JEPI is the defensive income choice; JEPQ is the growth-plus-income choice. Many investors hold both. Full JEPQ history is in [our JEPQ dividend history](/articles/jepq-dividend-history/).
...
*Comparison per [StockAnalysis.com](https://stockanalysis.com/etf/jepi/) and [NEOS](https://neosfunds.com/spyi/), August 2026.*
...
1. **Great for steady income** — ~8% yield, monthly, consistent since 2020
2. **Low volatility** — beta ~0.54, smaller drawdowns than the market
