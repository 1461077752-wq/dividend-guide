---
title: "VOO Dividend: Yield, History and Comparisons"
description: "VOO's current dividend yield, annual dividend history since 2012, quarterly payment schedule, and how the S&P 500 ETF's income compares to SCHD and VIG."
pubDate: 2026-08-04
modDate: 2026-08-04
...
author: "Henry Zhou"
dataAsOf: "2026-08-04"
methodology: "Annual dividend totals sum reported quarterly distributions; yield uses the stated price date."
sources:
...
<!-- Cover image: Stock market index chart with rising green line and the number 500, representing S&P 500 index investing -->
...
*Fund facts per [StockAnalysis.com VOO data](https://stockanalysis.com/etf/voo/), August 5, 2026. VOO is the largest ETF by assets.*
...
*Annual dividend data per [StockAnalysis.com VOO dividend history](https://stockanalysis.com/etf/voo/dividend/), cross-checked against dividend history sources. Values rounded; the 2014 figure is approximate.*
...
*Quarterly distribution data per [StockAnalysis.com](https://stockanalysis.com/etf/voo/dividend/), August 2026.*
...
VOO's ~1.04% yield matches the [S&P 500's aggregate dividend yield](https://www.multpl.com/s-p-500-dividend-yield) of about **1.04%** as of August 2026 — the two are identical because VOO is a direct index tracker. That's low by historical standards: the S&P 500 yield was closer to 1.5-2% in prior decades, but a decade-plus of strong price appreciation has pushed the yield down as prices grew faster than dividends.
...
*Yield data per [StockAnalysis.com](https://stockanalysis.com/etf/voo/), August 5, 2026.*
