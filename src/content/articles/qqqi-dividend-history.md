...
primaryKeyword: "QQQI dividend history"
...
<!-- Cover image: Stock market analytics chart displayed on a computer screen, representing Nasdaq covered-call income investing -->
...
*Fund facts per [NEOS fund disclosures](https://neosfunds.com/qqqi/), July 2026. Distribution rate is annualized and fluctuates with premiums and price.*
...
*Per-share distributions per [NEOS official distribution history](https://neosfunds.com/qqqi/) and cross-checked against [stockanalysis.com QQQI dividend data](https://stockanalysis.com/etf/qqqi/dividend/). Amounts are variable and should be verified against the fund's official distribution schedule before any decision.*

**The pattern:** QQQI's payouts are unusually steady for a covered-call fund. Monthly distributions have stayed in a tight $0.53–$0.66 band for 2.5 years — a stark contrast to single-stock covered-call funds like [MSTY](/articles/msty-dividend-history/), where monthly payouts can swing between $0.71 and $4.08. The two notable dips (March 2025 at $0.587, April 2025 at $0.531) both followed market volatility, not fund distress.
...
1. **Index options instead of single-stock calls.** QQQI writes options on the Nasdaq-100 index (NDX), not on individual stocks. A diversified index produces steadier, lower-volatility option premiums than a single volatile stock like Nvidia or MicroStrategy.
2. **Buying calls too, not just selling them.** QQQI combines sold calls with purchased calls (a call-spread structure). This preserves more upside in rising markets while still generating income — a key reason the fund's NAV has held up.
3. **Section 1256 tax treatment.** Because the fund uses exchange-traded NDX index options, gains and most distributions are taxed at the lower 60/40 rate and classified largely as return of capital, which makes QQQI more tax-efficient than funds using ELN-based strategies.

Per [NEOS strategy documentation](https://neosfunds.com/qqqi/), the fund's "data-driven" approach targets consistent premium capture while managing downside, which explains why its payouts look more like a coupon than a lottery ticket.
...
*Performance figures per [NEOS fund performance data](https://neosfunds.com/qqqi/) and [stockanalysis.com](https://stockanalysis.com/etf/qqqi/), as of late July / early August 2026. Past performance does not guarantee future results.*

**What this means:** over its short life, QQQI's ~14% distribution yield has come mostly from genuine premium income — not from slowly handing back your own capital, which is the trap in many single-stock covered-call funds. Over the same window the Nasdaq-100 index gained about 64% cumulatively, so QQQI lagged its underlying index (as any options strategy should) while beating the Cboe Nasdaq-100 BuyWrite benchmark of roughly +39% cumulative per [NEOS index comparison data](https://neosfunds.com/qqqi-comparison/).
...
*Fund data per [NEOS](https://neosfunds.com/qqqi-comparison/), [JPMorgan](https://am.jpmorgan.com/), and Global X fund pages, July 2026. Yields and returns fluctuate.*
...
Mostly no — QQQI's distributions are largely classified as return of capital and option-related income, which is treated differently from qualified corporate dividends on [Form 1099-DIV](https://www.irs.gov). The return-of-capital portion is not taxed immediately but reduces your cost basis. The 60/40 rate on the options portion is a major tax advantage over ELN-based rivals.
